...
<body>
    ...
    <div >
     ...
     <main class="container">
        ...
        <div class="row">
            <div class="col-sm-6">
                <h3>ΛΙΣΤΑ ΠΡΟΪΟΝΤΩΝ</h3>
                <div id="product-div"></div>
            </div>
            <div class="col-sm-3"></div>
            <div class="col-sm-3">
                <h3>ΠΡΟΣΘΗΚΗ</h3>
                <form action="resources/prodcats-res.php" method="post">
                    <div class="form-group">
                        <label>ΠΕΡΙΓΡΑΦΗ ΠΡΟΪΟΝΤΟΣ</label>
                        <input type="text" name="name" class="form-control" placeholder="NΕΟ ΠΡΟΪΟΝ">
                    </div>
...
<script>
    $(document).ready(function(){
        ...
        {
            $.ajax({
                url:"resources/prodcatsdisplay-res.php",
                mehtod:"POST",
        ...
        $(document).on('click','.delete',function(){
            ...
            {
                $.ajax({
                    url:"resources/deleteprods-res.php",
                    method:"POST",
                    data:{id:id},
                    success:function(data)
                    {
