...
<body>
    ...
    <div >
     ...
     <main class="container">
        ...
        <div class="row">
            <div class="col-sm-6">
                <h3>ΛΙΣΤΑ ΚΑΤΑΣΚΕΥΑΣΤΩΝ</h3>
                <div id="product-div"></div>
            </div>
            <div class="col-sm-3"></div>
            <div class="col-sm-3">
                <h3>ΠΡΟΣΘΗΚΗ</h3>
                <form action="resources/manufacturercats-res.php" method="post">
                    <div class="form-group">
                        <label>ΟΝΟΜΑ ΚΑΤΑΣΚΕΥΑΣΤΗ</label>
                        <input type="text" name="name" class="form-control" placeholder="ΝΕΟΣ ΚΑΤΑΣΚΕΥΑΣΤΗΣ">
                    </div>
...
<script>
    $(document).ready(function(){
        ...
        {
            $.ajax({
                url:"resources/mancatsdisplay-res.php",
                mehtod:"POST",
        ...
        $(document).on('click','.delete',function(){
            ...
            {
                $.ajax({
                    url:"resources/deletemanufacturer-res.php",
                    method:"POST",
                    data:{id:id},
                    success:function(data)
                    {
