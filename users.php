    ...
    <div >
     ...
     <main class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <h3>ΠΡΟΣΘΗΚΗ</h3>
                <form action="resources/users-res.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select name="point" class="form-control form-control-sm">
                            <option value="Κεντρικό">Κεντρικό</option>
                            <option value="Ιασωνίδου">Ιασωνίδου</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <span>Είδος Χρήστη</span>
...
<script>
    $(document).ready(function(){
        ...
        {
            $.ajax({
                url:"resources/usersdisplay-res.php",
                mehtod:"POST",
        ...
        $(document).on('click','.delete',function(){
            ...
            {
                $.ajax({
                    url:"resources/deleteuser-res.php",
                    method:"POST",
                    data:{id:id},
                    success:function(data)
                    {
