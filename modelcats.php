...
<body>
    ...
    <div >
     ...
     <main class="container">
        ...
        <div class="row">
            <div class="col-sm-6">
                <h3>ΛΙΣΤΑ ΜΟΝΤΕΛΩΝ ΚΑΤΑΣΚΕΥΑΣΤΩΝ</h3>
            ...
            <div class="col-sm-3">
                ...
                <form action="resources/modelcats-res.php" method="post">
                    <div class="form-group">
                        ...
                        <label>ΜΟΝΤΕΛΟ</label>
                        <input type="text" name="name" class="form-control" placeholder="ΝΕΟ ΜΟΝΤΕΛΟ">
                    </div>
...
<script>
    $(document).ready(function(){
        ...
        {
            $.ajax({
                url:"resources/modeldisplay-res.php",
                mehtod:"POST",
        ...
        $(document).on('click','.delete',function(){
            ...
            {
                $.ajax({
                    url:"resources/deletemodel-res.php",
                    method:"POST",
                    data:{id:id},
                    success:function(data)
                    {
